...
input_direction = input("Do you want to go Left or Right?\n")
input_direction = input_direction.lower()

if input_direction == "left":
    input_action = input("Do you want to Swim or Wait?\n")
    input_action = input_action.lower()
    if input_action == "swim":
        input_color = input(
            "Which door you want to enter? Red, Blue, Yellow...?\n")
